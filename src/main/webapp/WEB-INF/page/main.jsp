...
<div id="app" v-cloak>
    ...
    <div>
        ...
        <div>
            <span  style="text-align: center;display:block;font-size: 28px">新上好课</span>
        </div>
        <el-row style="margin-top:5px">
            <el-col :span="6" v-for="(o, index) in newCourseList" :key="o" :offset="index == 0 || index%3 == 0 ? 2 :1">
        ...
        <div style="margin-top:20px">
            <span  style="text-align: center;display:block;font-size: 28px">热门课程</span>
        </div>
        <el-row style="margin-top:5px">
            <el-col :span="6" v-for="(o, index) in hotCourseList" :key="o" :offset="index == 0 || index%3 == 0 ? 2 :1">
                <el-card :body-style="{ padding: '0px'}" style="margin-top:15px" shadow="hover">
                    <img :src="o.coursePhoto" class="image">
                    <div style="padding: 14px;">
                        <span>{{o.courseName}}</span>
        ...
        <div style="margin-top:20px">
            <span  style="text-align: center;display:block;font-size: 28px">基础课程</span>
        </div>
        <el-row style="margin-top:5px">
            <el-col :span="6" v-for="(o, index) in easyCourseList" :key="o" :offset="index == 0 || index%3 == 0 ? 2 :1">
                <el-card :body-style="{ padding: '0px'}" style="margin-top:15px" shadow="hover">
                    <img :src="o.coursePhoto" class="image">
                    <div style="padding: 14px;">
                        <span>{{o.courseName}}</span>
...
<script>
    var vue = new Vue({
        ...
        methods: {
            ...
            getCourse:function(){
                var self=this;
                axios.get(this.contextPath+"api/course/indexQueryByCount").then(function(res){
                    self.hotCourseList=res.data;
                });
                axios.get(this.contextPath+"api/course/indexQueryCreateTime").then(function(res){
                    self.newCourseList=res.data;
                });
                axios.get(this.contextPath+"api/course/indexQueryByLevel").then(function(res){
                    self.easyCourseList=res.data;
                });
            },
            ...
            getNotice:function() {
                var self=this
                axios.get(this.contextPath+"api/notice/queryByStatus").then(function(res){
                    self.notice=res.data;
                    for(var i=0;i<self.notice.length;i++) {
                            self.$notify({
                                title: '公告',
                                message: self.notice[i].noticeContent,
                                duration: 0,
                                offset: 100*i
                            });
                    }
